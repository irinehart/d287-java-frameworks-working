...
class PartTest {
    ...
    void getMinimumInventory() {
        int minimum=5;
        partIn.setMinimumInventory(minimum);
        assertEquals(minimum, partIn.getMinimumInventory());
        partOut.setMinimumInventory(minimum);
        assertEquals(minimum, partOut.getMinimumInventory());
    }

    @Test
    void getMaximumInventory() {
        int maximum=5;
        partIn.setMaximumInventory(maximum);
        assertEquals(maximum, partIn.getMaximumInventory());
        partOut.setMaximumInventory(maximum);
        assertEquals(maximum, partOut.getMaximumInventory());
    }
